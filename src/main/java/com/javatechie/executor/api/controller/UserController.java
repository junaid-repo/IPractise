...
public class UserController {
	...
	public ResponseEntity<CompletableFuture<String>> saveListOfUsers(@RequestBody List<User> usersList) {

		CompletableFuture<String> response = service.saveListOfUsers(usersList);
